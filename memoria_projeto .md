...
### 2026-06-14 — Correção do [Cron Error] fetch_metadata
- ✅ Adicionado jitter aleatório (0 a 15 segundos) nas Crons para espalhar requisições simultâneas de grupos.
- ✅ Aumentado o número de retries de `fetch_metadata` de 1 para 3 em `executeWithRetry` para tolerar microdesconexões.
- ✅ Deploy realizado com sucesso para o caminho correto na VPS (`/home/ubuntu/nazuna-bot/dados/src/index.js`).
- ✅ Bot reiniciado e online no PM2.
